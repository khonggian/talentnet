...
$config['LicenseName'] = 'www.crscb.cz';
$config['LicenseKey'] = 'M63S-FK13-X35P-MK15-3379-DN1K-BDF7';
...
*/
$dir_upload_editor= 'uploads/editor/';
$baseUrl = $_COOKIE['base_url'].$dir_upload_editor;
...
$baseDir = resolveUrl($_COOKIE['base_url'].$dir_upload_editor);
