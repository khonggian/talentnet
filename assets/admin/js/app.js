var App = function () {
    ...
    var handleStyler = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", base_url + "assets/admin/css/style_" + color + ".css");
        }
        ...
        var setLayout = function () {
            if ($('input.header', panel).is(":checked")) {
				...
				$.cookie('fixed_top', true, { path: '/' });
            } else {
                $("body").removeClass("fixed-top");
                $(".header").removeClass("navbar-fixed-top");
				$.cookie('fixed_top', 'none', { path: '/' });
            }
        }
    }
    ...
    return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="'+base_url+'assets/admin/img/loading.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
