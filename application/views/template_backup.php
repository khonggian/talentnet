		...
		<div id="footer">
			<div class="contact">
				<div class="row">
					...
					<div class="col-md-4 txt-r"><a href="https://www.linkedin.com/company/talentnet-corporation?trk=tyah&trkInfo=tarId%3A1423191960019%2Ctas%3Atalentnet+cor%2Cidx%3A1-1-1" title="" target="_blank">FOLLOW US <img src="<?=base_url()?>assets/img/icon/icon-in.png" alt="" /></a></div>
				</div>
			</div>
			<div class="copy">
				<div class="row">
