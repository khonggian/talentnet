...
*  Mail  	   : tessierronan [at] yahoo [dot] fr
*
...
class GA_Api {
	...
	var $accounts_home	= 'https://www.googleapis.com/analytics/v2.4/management/accounts/~all/webproperties/~all/profiles';
	...
	{		
		...
		foreach($entries as $entry) 
		{
			...
			$this->accounts[$title]['tableId'] = (!empty($tableIds->item(0)->nodeValue)) ? $tableIds->item(0)->nodeValue : '';
