			...
			<div class="table-clients mt24">
                <div class="faq-search mbt14" style="">
					...
					<div class="search-wrapper-f-s">
						...
						<div class="f-s61">
						<div class="title"><?=lang('industry');?></div>
										...
										<div class="">
											<div class="select left lc" style="width:70%;">
												<select class="js-select" name="industry">
													...
													?>
													<option value="<?php echo $row->id; ?>" <?=$row->id==$this->input->get('i')?'selected="selected"':''?>><?php echo $row->$indus; ?></option>
													<?php } ?>
												</select>
											</div>
											<div class="clearfix"></div>
				...
				<table>
                    ...
                    <tr <?php if($i == 0){echo 'class="bdt"'; $i++;}?>><td>
						<div class="client-name"><?=$row->$lang_name?></div>
                    ...
                    <?php  } }else{ ?>
					<tr>
						<td><div class="c_update"><?= lang('no_result');?></div></td>
					</tr>
                    <?php }?>
				</table>
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        $('a#btSearchClients').bind('click',function(){
            ...
            i= $('select[name="industry"]').val();
            window.location = '<?=current_url()?>?k='+ k + '&r=' + r + '&i=' + i;
        });
