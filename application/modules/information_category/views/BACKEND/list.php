...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="span12"> 
			...
			<h3 class="page-title">
				Manage infomation category <small>Page List</small>
			</h3>
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
							...
							<table class="table table-striped table-bordered table-hover _table" id="sample_1">
								...
								<tbody>								
									...
									<tr class="odd gradeX" data-id="<?=$row->id?>">
										...
										<td class="center vl-m"><?=$row->order?></td>
										<td class="center vl-m" data-field=""><?=$row->name_vi?></td>
										...
										<td class="center vl-m" data-field=""><img src="<?=DIR_UPLOAD_INFORMATION_CATEGORY.$row->image?>" width="150" /></td>
										<td class="center vl-m" data-field="status"><?=getStatus($row->status)?></td>
