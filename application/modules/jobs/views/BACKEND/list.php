		...
		<div class="span12">
			...
			<div class="portlet box green">
				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							<a href="<?=current_url()?>/edit" id="sample_editable_1_new" class="btn green">
					...
					<table class="table table-striped table-bordered table-hover _table" id="sample_1">
						<thead>
							<tr>
								...
								<th class="center field_status">Nổi bật</th>
						...
						<tbody>								
							...
							<tr class="odd gradeX" data-id="<?=$row->id?>">
								...
								<td class="center vl-m" data-field=""><?=$row->name_function?></td>
								<td class="center vl-m" data-field=""><?=$row->name_industry?></td>
								<td class="center vl-m" data-field=""><?=$row->name_location?></td>
								<td class="center vl-m" data-field=""><?=$row->name_level?></td>
								<td class="center vl-m" data-field=""><?=$row->name_en?></td>
								<td class="center vl-m" data-field="hot">
									<?=getStatus($row->hot,'hot')?>
								</td>
								<td class="center vl-m" data-field="status">
									<?=getStatus($row->status)?>
								</td>
								<td class="center vl-m" data-field=""><?=date('d/m/Y H:i:s', strtotime($row->changed))?></td>
								<td class="center vl-m" data-field=""><?=date('d/m/Y H:i:s', strtotime($row->created))?></td>
								<td class="center vl-m">
									<a href="<?=current_url()."/edit?mid={$mid}&nid={$row->id}"?>">Edit</a> | <a class="item-delete _btn">Delete</a>
								</td>
							</tr>
							<?php
									}
							...
							?>
							<tr class="odd gradeX">
								<td colspan="6" class="center"><strong>Empty</strong></td>
							</tr>
							<?php
								}
							?>
