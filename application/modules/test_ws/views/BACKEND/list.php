...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="span12"> 
			...
			<h3 class="page-title">
				<?=ucfirst($module)?> <small>Page List</small>
			</h3>
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
					...
					<table class="table table-striped table-bordered table-hover _table" id="sample_1">
						...
						<tbody>								
							...
							<tr class="odd gradeX" data-id="<?=$row->id?>">
								...
								<td></td>
								<td class="center vl-m" data-field=""><?=$row->name?></td>
							...
							?>
							<tr class="odd gradeX">
								<td colspan="0" class="center td-colspan"><strong>Empty</strong></td>
							</tr>
							<?php
								}
							?>
